...
- Route 53 **Resolver** (covered in [04 - Health Checks, DNSSEC, Resolver & Hybrid DNS](04%20-%20Health%20Checks%2C%20DNSSEC%2C%20Resolver%20%26%20Hybrid%20DNS.md)) is the separate component that _does_ resolve queries inside a VPC.
...
> **Exam Trap:** If you change a record but clients still see the old value, it is **TTL caching** at resolvers - not a Route 53 bug. Lower the TTL _before_ a planned change.
