...
> [!warning] Exam trap
> "Variable CPU, mostly idle, cost-sensitive, occasional spikes" → **T-family (Unlimited if spikes must not throttle)**. But if a workload is **sustained high CPU**, T in Unlimited mode gets _expensive_ — switch to **M or C**. Burstable ≠ free performance.
...
| **G (G4dn, G5, G6)** | NVIDIA T4/A10G GPU              | ML **inference**, graphics/rendering, game streaming, [5G edge](01%20-%20Wavelength%20Intro.md) |
