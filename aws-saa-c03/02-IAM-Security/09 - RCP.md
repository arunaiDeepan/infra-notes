...
See also: [08 - SCP](08%20-%20SCP.md) · [10 - Declarative Policies](10%20-%20Declarative%20Policies.md) · [11 - Permissions Boundaries](11%20-%20Permissions%20Boundaries.md) · [19 - IAM Cross Account Access](19%20-%20IAM%20Cross%20Account%20Access.md) · [23 - IAM Security Tools](23%20-%20IAM%20Security%20Tools.md) · [29 - Ex Qns](29%20-%20Ex%20Qns.md)
...
A **Resource Control Policy (RCP)** is a policy in AWS Organizations that **sets maximum permissions for AWS resources** in member accounts. While SCPs control what _principals_ can do, RCPs control what _resources_ can be accessed and by whom.
...
**The problem with the old approach:** Resource policies had to be attached to _every single resource_. With thousands of S3 buckets, this was nearly impossible to enforce.
...
**Effect:** Any principal not in your organization is denied access to _every resource_ in accounts under this RCP.
...
- Principals outside your organization: Cannot access _any_ resource in affected accounts
...
**Key difference from SCP:** This RCP blocks _even the resource owner_ if they try to delete version data. An SCP could be bypassed if the principal is in the management account, but RCP cannot.
