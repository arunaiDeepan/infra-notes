...
**Exam Trap:** Answer C is a common distractor. Being in a member account doesn't exempt you from SCPs - being in the *management account* does.
...
**Explanation:** RCPs are designed exactly for this - controlling *who* can access resources. A single RCP at the root applies to **all resources** in all member accounts, eliminating the need for individual bucket policies. SCPs control what principals can do, not who can access resources.
