...
6. **For workforce / multi-account console access**, use **IAM Identity Center**, not Cognito. (Identity Center is for *employees* signing into AWS; Cognito is for your *customers* signing into your app.)
...
- Together they let an app authenticate users *and* give them scoped AWS access - without baking long-term keys into the client.
