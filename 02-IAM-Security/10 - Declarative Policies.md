...
See also: [08 - SCP](08%20-%20SCP.md) · [09 - RCP](09%20-%20RCP.md) · [11 - Permissions Boundaries](11%20-%20Permissions%20Boundaries.md) · [06 - IAM Identity Center & Organizations](06%20-%20IAM%20Identity%20Center%20%26%20Organizations.md) · [23 - IAM Security Tools](23%20-%20IAM%20Security%20Tools.md) · [28 - Ex Qns](28%20-%20Ex%20Qns.md)
...
A **Declarative Policy** is a management policy in AWS Organizations that enforces **desired configurations** for AWS services across your organization. Unlike SCPs and RCPs (which control *who* can do *what*), declarative policies control *how services are configured* .
...
- Users understand it's a *configuration restriction*, not a *permissions issue*
