...
> **Exam Trap:** If you need S3 **website redirects or index documents**, you must use the S3 **website endpoint**, which is a *custom* origin and **cannot use OAC** (the bucket must be public). To keep the bucket private, use the **REST endpoint with OAC** and lose website features.
