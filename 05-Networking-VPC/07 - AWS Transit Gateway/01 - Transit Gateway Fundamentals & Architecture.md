...
| **Topology** | Hub-and-spoke; spokes are *attachments* |
...
> **Exam Tip:** TGW is **regional**. To connect VPCs in *different* regions you peer two Transit Gateways together. There is no single global TGW.
...
- **VPC peering has no per-GB processing charge within the same AZ** and no hourly attachment fee, so for *just two* VPCs peering is usually cheaper.
