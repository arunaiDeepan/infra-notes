...
> **Security Groups** are *stateful* firewalls at the instance/ENI level; **Network ACLs** are *stateless* firewalls at the subnet level. Knowing the stateful-vs-stateless difference, ephemeral ports, and rule evaluation order wins a surprising number of exam questions.
