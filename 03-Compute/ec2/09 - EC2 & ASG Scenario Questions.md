...
**A.** EC2 status checks only confirm the instance is *running*, not that the app is healthy. Switch the ASG **health-check type to ELB** so app failures trigger replacement. See [06 - EC2 Auto Scaling (ASG) > 🩺 Health Checks - EC2 vs ELB](06%20-%20EC2%20Auto%20Scaling%20%28ASG%29.md#-health-checks---ec2-vs-elb).
</details>
