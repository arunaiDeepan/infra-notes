...
**Key Insight**: Batch dynamically provisions compute resources *only when jobs are waiting*. The EC2 instances or Fargate tasks are created, run your container, and terminate. This is what makes it cost-effective .
