...
2. **It runs on AWS bare-metal hardware** in AWS data centers (you don't bring hardware; unlike [Outposts](01%20-%20Outposts%20Intro.md), the hardware lives in *AWS's* facility).
