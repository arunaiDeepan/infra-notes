...
> **Exam nugget:** **Hybrid Linked Mode** = **single-pane-of-glass** management across on-prem and cloud vCenters. It's about *management visibility*, not data movement (that's HCX).
