...
**Why SAR:** **public** listing + **verified author** badge + **public `SourceCodeUrl`** lets external customers discover and deploy into *their own* accounts — they run/pay for their own resources. (For paid commercial software, **AWS Marketplace** is the billing-integrated alternative.)
...
You don't need to memorize specific apps, but recognizing the *category* helps decode scenarios:
