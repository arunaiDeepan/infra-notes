...
> **Exam Trap:** Just because EKS-D "uses the same binaries as EKS" does NOT mean it reduces your operational overhead. The *managed service* (EKS) is what reduces overhead.
