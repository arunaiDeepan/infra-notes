...
> **Exam Tip:** EKS-D itself has no installer — that is precisely why **EKS Anywhere** exists. EKS Anywhere is an opinionated, supported product that *uses* EKS-D as its distribution.
...
| "EKS Anywhere is just EKS-D" | **False** | EKS Anywhere is a product *built on* EKS-D with added tooling |
